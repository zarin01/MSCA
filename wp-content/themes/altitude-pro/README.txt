...
* Changed: Update Google Font URL to latest version. The Ek Mukta font is now known as Mukta. Updating the font name also makes the theme compatible with the [OMGF plugin](https://wordpress.org/plugins/host-webfonts-local/).
